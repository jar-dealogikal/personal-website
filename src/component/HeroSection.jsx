			...
			<div className="relative isolate pt-12">
				...
				<div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-16 lg:px-8 lg:py-40">
					<div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
						<h1 className="max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl text-center font-serif">
						...
						<div className="mt-20 flex items-center gap-x-6">
							...
							>
								<FaFacebook className="h-8 w-8 text-black hover:text-rose-500" />
							</a>
							<a
								...
								className="cursor-pointer "
							>
								<FaInstagram className="h-8 w-8 text-black hover:text-rose-500" />
							</a>
							<a href="mailto:someone@example.com" className="cursor-pointer">
								<FaEnvelope className="h-8 w-8 text-black hover:text-rose-500" />
							</a>
						</div>
					</div>
					<div className="mt-16 sm:mt-20 lg:mt-0 lg:flex-grow">
						<img
							src={img2}
							alt="logo"
							className="h-[30rem] w-[30rem] rounded-md shadow-lg shadow-red-300"
						/>
					</div>
				</div>
			</div>
