...
export default function Footer() {
	return (
		<footer id="contact" aria-labelledby="footer-heading" className="bg-white">
			...
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-14">
				<div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
					<div>
						...
						<p className="mt-2 text-sm leading-6 text-gray-600">
							The latest post, blogs, and resources, sent to your inbox
							weekly.
						</p>
					</div>
				...
				<div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
					...
					<p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
						&copy; 2024 Jamila Omalan, Inc. All rights reserved.
					</p>
				</div>
			</div>
		</footer>
